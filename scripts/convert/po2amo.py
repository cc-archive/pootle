...
class po2amo:
  def convertstore(self, thepofile):
    ...
    for unit in thepofile.units:
      ...
      # If there's a plural in the po file, then there should be in the amo file
      ...
      # No need to alter the msgstr; it is foreign in the original file, and 
      # we started with that as a base
