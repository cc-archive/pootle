  ...
  def convertstore(self, engfile, forfile):
    ...
    for engunit in engfile.units:
      ...
      if engunit.isheader():
        ...
        except: # If there's no foreign header, reluctantly use english header  
      ...
      # We want to put the english translation as the id and the key as the
      # context
...
def convertamo(inputfile, outputfile, templatefile):
