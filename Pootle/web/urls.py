...
urlpatterns = patterns('Pootle.web.views',
    ...
    (r'^(?P<language>\w+)/(?P<project>\w+)/translate/(?P<subdir>[\w/]*?)(?P<filename>\w+\.po)', 'file_translate'),
    (r'^(?P<language>\w+)/(?P<project>\w+)/download/(?P<subdir>[\w/]*?)(?P<filename>\w+\.po)', 'file_download'),
    (r'^(?P<language>\w+)/(?P<project>\w+)/review/(?P<subdir>[\w/]*?)(?P<filename>\w+\.po)', 'file_review'),
    (r'^(?P<language>\w+)/(?P<project>\w+)/overview/(?P<subdir>[\w/]*?)(?P<filename>\w+\.po)', 'file_overview'),
